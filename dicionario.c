...
void regras_infos(void){												//Função para indicas regras e informações sobre a utilização do programa
    ...
    printf("\n");
	printf("\n10.O código está disponivel no github, acesse: https://github.com/GuiMarcos/DicionarioBinarySearchTree.git");
    printf("\n");
}

void base_dic2(FILE *arq){												//Função que realiza a leitura da Base de Dados previamente tratada
    Dicionario *temp;													//Retirada inicialmente de https://www.kaggle.com/borrkk/dictionary
